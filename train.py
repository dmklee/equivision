...
from lightning.pytorch.callbacks import Timer, ModelCheckpoint, LearningRateMonitor
...
class ImageNetDataModule(L.LightningDataModule):
    def __init__(self, data_dir: str = "./datasets", batch_size: int = 128, num_workers: int=8) -> None:
        super().__init__()
...
def main(hparams):
    ...
    datamodule = ImageNetDataModule(hparams.data_dir, hparams.batch_size, hparams.num_workers)
